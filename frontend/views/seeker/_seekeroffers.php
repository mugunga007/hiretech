    ...
    <div class="panel panel-default mine">
        ...
        <div class="panel-body">
            ...
            if($model->status == 'Confirmed') {
                ...
                ?>
                <p class="btn btn-success text-center disabled"><i class="fa fa-stamp"></i> You Accepted This Offer </p>
                <?php
            }else {
                ?>
            <p class="btn btn-danger text-center disabled"><i class="fa fa-stamp"></i> You Denied This Offer </p>
            <?php
            }
            ?>
